...
;	./src/swspi.c: 20: uint16_t maska=0b1<<15; 
; genAssign
	ldw	x, #0x8000
	ldw	(0x01, sp), x
...
;	./src/swspi.c: 23: if(maska & data){DIN_H;}else{DIN_L;}
; genAnd
	ld	a, (0x02, sp)
	and	a, (0x06, sp)
	ld	xl, a
...
;	./src/swspi.c: 25: maska = maska >> 1;
; genRightShiftLiteral
	srl	(0x01, sp)
	rrc	(0x02, sp)
	Sswspi$swspi_tx16$53 ==.
;	./src/swspi.c: 26: CLK_L;
; genIPush
	push	#0x08
...
Ldebug_line_stmt:
	...
	.db	1
	.db	9
	.dw	Sswspi$swspi_tx16$47-Sswspi$swspi_tx16$34
	.db	3
	.sleb128	1
	.db	1
	.db	9
	.dw	Sswspi$swspi_tx16$52-Sswspi$swspi_tx16$47
	.db	3
	.sleb128	1
	.db	1
	.db	9
	.dw	Sswspi$swspi_tx16$53-Sswspi$swspi_tx16$52
	.db	3
	.sleb128	1
	.db	1
	.db	9
	.dw	Sswspi$swspi_tx16$59-Sswspi$swspi_tx16$53
	.db	3
	.sleb128	2
	.db	1
	.db	9
	.dw	Sswspi$swspi_tx16$64-Sswspi$swspi_tx16$59
	.db	3
	.sleb128	1
	.db	1
	.db	9
	.dw	1+Sswspi$swspi_tx16$66-Sswspi$swspi_tx16$64
	.db	0
	.uleb128	1
	.db	1
Ldebug_line_end:
...
Ldebug_loc_start:
	...
	.db	120
	.sleb128	6
	.dw	0,(Sswspi$swspi_tx16$55)
	.dw	0,(Sswspi$swspi_tx16$56)
	.dw	2
	.db	120
	.sleb128	5
	.dw	0,(Sswspi$swspi_tx16$54)
	.dw	0,(Sswspi$swspi_tx16$55)
	.dw	2
	.db	120
	.sleb128	4
...
Ldebug_CIE0_end:
	...
	.dw	0,Sswspi$swspi_tx16$67-Sswspi$swspi_tx16$24
	.db	1
	.dw	0,(Sswspi$swspi_tx16$24)
	.db	14
	.uleb128	2
